...
namespace RNSReloaded.CustomBossTest {
    public unsafe class Patterns {
        ...
        public void bp_fire_aoe(CInstance* self, CInstance* other, int spawnDelay, int eraseDelay, double scale, (double, double)[] points) {
            if (this.rnsReloadedRef.TryGetTarget(out var rnsReloaded)) {
        ...
        public void bp_knockback_circle(CInstance* self, CInstance* other, int spawnDelay, int kbAmount, int radius, int warnMsg, (double, double) position) {
            if (this.rnsReloadedRef.TryGetTarget(out var rnsReloaded)) {
                // Set up vars needed to spawn pattern
                RValue[] args = [
                    //this.utils!.CreateString("warningDelay")!.Value, new RValue(warningDelay),
        ...
        public void bp_cone_direction(CInstance* self, CInstance* other, int spawnDelay, int fanAngle, (double, double) source, double[] rots) {
            if (this.rnsReloadedRef.TryGetTarget(out var rnsReloaded)) {
                // Set up vars needed to spawn pattern
                RValue[] args = [
                    //this.utils!.CreateString("warningDelay")!.Value, new RValue(warningDelay),
        ...
        public void bp_cone_spreads(CInstance* self, CInstance* other, int spawnDelay, int fanAngle, (double, double) source, int? targetMask) {
            if (this.rnsReloadedRef.TryGetTarget(out var rnsReloaded)) {
                // Set up vars needed to spawn pattern
                RValue[] args = [
                    //this.utils!.CreateString("warningDelay")!.Value, new RValue(warningDelay),
        ...
        public void bp_water2_line(CInstance* self, CInstance* other, int spawnDelay, (double, double) position, double angle, double lineAngle, int lineLength, int num, int spd) {
            if (this.rnsReloadedRef.TryGetTarget(out var rnsReloaded)) {
                // Set up vars needed to spawn pattern
                RValue[] args = [
                    //this.utils!.CreateString("warningDelay")!.Value, new RValue(warningDelay),
        ...
        public void bp_fire2_line(CInstance* self, CInstance* other, int spawnDelay, (double, double) position, double angle, double lineAngle, int lineLength, int num, int spd) {
            if (this.rnsReloadedRef.TryGetTarget(out var rnsReloaded)) {
                // Set up vars needed to spawn pattern
                RValue[] args = [
                    //this.utils!.CreateString("warningDelay")!.Value, new RValue(warningDelay),
